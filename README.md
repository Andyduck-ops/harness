...
> Model capability is the ceiling; the harness determines what actually ships.
...
| 文档 | 内容 |
|------|------|
| [PRD/vision.md](./PRD/vision.md) | 问题、论点、北极星 |
| [PRD/core-principles.md](./PRD/core-principles.md) | 12 条核心原则 |
| [PRD/architecture/](./PRD/architecture/) | 系统架构、执行模型、知识系统 |
| [PRD/validation/](./PRD/validation/) | 质量门、成功标准 |
| [PRD/boundaries/](./PRD/boundaries/) | 范围、安全边界 |
