...
| 3 | [agent-scope-identity-memory-governance](./runtime-governance/agent-scope-identity-memory-governance.md) | runtime-governance | 0.86 | 40 |
...
| 3 | [required-checks-snapshot-closure-gate](./product-delivery/required-checks-snapshot-closure-gate.md) | product-delivery | 0.79 | 35 |
