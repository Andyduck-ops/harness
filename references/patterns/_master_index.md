...
| 3 | [approval-batch-shock-absorber-gate](./capacity-governance/approval-batch-shock-absorber-gate.md) | capacity-governance | 0.78 | OPML + HN API(top/show/new) + GitHub Merge Queue + merge_group + Review Deployments |
...
| 3 | [token-spec-pinning-attestation-gate](./token-governance/token-spec-pinning-attestation-gate.md) | token-governance | 0.78 | OPML + HN(top/show/newest) + Design Tokens + Storybook + GitHub Attestations |
...
| 3 | [agent-memory-partition-least-privilege-gate](./permission-governance/agent-memory-partition-least-privilege-gate.md) | permission-governance | 0.78 | OPML + HN + OpenAI + GitHub |
| 3 | [external-identity-lease-replay-gate](./identity-governance/external-identity-lease-replay-gate.md) | identity-governance | 0.77 | OPML + HN + OpenAI + GitHub |
...
| 3 | [show-lane-executability-gate](./discovery-governance/show-lane-executability-gate.md) | discovery-governance | 0.79 | OPML + HN(news/show/newest) + GitHub Merge Queue + merge_group + Protected Branches |
...
| 3 | [conflict-intake-required-form-gate](./control-plane-governance/conflict-intake-required-form-gate.md) | control-plane-governance | 0.78 | OPML + HN(news/show/newest) + GitHub Issue Forms + merge_group + Required Checks |
| 3 | [conflict-form-schema-drift-gate](./control-plane-governance/conflict-form-schema-drift-gate.md) | control-plane-governance | 0.79 | OPML + HN(news/show/newest) + GitHub Issue Forms + Validation Errors + merge_group + Required Checks |
...
| 3 | [queue-reorder-rebuild-attestation-gate](./queue-governance/queue-reorder-rebuild-attestation-gate.md) | queue-governance | 0.78 | OPML + HN + GitHub Merge Queue + merge_group + GraphQL |
...
| 3 | [backend-contract-first](./fullstack-engineering/backend-contract-first.md) | fullstack-engineering | 0.66 | HN blogs + HN snapshots |
...
| [permission-governance/](./permission-governance/) | 3 | 会话最小权限、漂移分级预算与记忆分区重放门禁治理 |
| [identity-governance/](./identity-governance/) | 1 | 外部身份租约、会话回放绑定与晋级门禁治理 |
